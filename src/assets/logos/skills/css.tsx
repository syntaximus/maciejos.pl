export const Css = ({ style }: { style?: React.CSSProperties }) => (
  <svg style={style} fill='none' height='2500' width='2183' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 124 141.53'>
