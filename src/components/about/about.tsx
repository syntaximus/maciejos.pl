...
const About = (props: IAboutProps) => (
  <div id='about' className='about'>
    ...
    <p>
      Od najmłodszych lat interesuję się technologiami. Dzięki zacięciu matematycznemu i informatycznemu, ukończyłem
      informatykę na wydziale{' '}
    ...
    <p>
      ...
      . Gdy nie ma mnie przy komputerze najczęściej zajmuję się swoim hobby jakim jest triathlon, a dokładniej trening
